...
The first line of each test case contains an integer `n` (`1 ≤ n ≤ 2·10⁵`) — the length of the array.

The second line of each test case contains `n` integers `a₁, a₂, …, aₙ` (`1 ≤ aᵢ ≤ n`) — the elements of the array.
