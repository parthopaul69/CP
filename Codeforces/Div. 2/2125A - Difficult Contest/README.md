...
Each test consists of several test cases. The first line contains a single integer `t` (`1 ≤ t ≤ 10⁴`) — the number of test cases. The description of the test cases follows.

The only line of each test case contains `s` (`1 ≤ |s| ≤ 2 · 10⁵`).

Additional constraints on the input data:

 - the total length of strings across all test cases does not exceed `2 · 10⁵`.
...
> 🔗 [View on Codeforces](https://codeforces.com/contest/2125/problem/A)
