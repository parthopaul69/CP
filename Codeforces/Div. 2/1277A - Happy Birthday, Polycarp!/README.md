...
| Field | Value |
|---|---|
| **Contest** | [1277](https://codeforces.com/contest/1277) |
| **Problem** | [1277A — Happy Birthday, Polycarp!](https://codeforces.com/contest/1277/problem/A) |
| **Rating** | 1000 |
| **Tags** | implementation |
| **Verdict** | ✅ Accepted |
...
Each test case consists of one line, which contains a positive integer `n` (`1 ≤ n ≤ 10⁹`) — how many years Polycarp has turned.
...
> 🔗 [View on Codeforces](https://codeforces.com/contest/1277/problem/A)
