...
The first line of each test case contains an integer `n` (`1 ≤ n ≤ 10⁵`) — the number of elements in the array `a`.

The second line contains `n` space-separated integers `a₁`, `a₂`, `…`, `aₙ` (`1 ≤ aᵢ ≤ 10⁹`) — the elements of the array `a`.
