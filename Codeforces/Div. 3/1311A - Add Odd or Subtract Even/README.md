...
Then `t` test cases follow. Each test case is given as two space-separated integers `a` and `b` (`1 ≤ a, b ≤ 10⁹`).
...
> 🔗 [View on Codeforces](https://codeforces.com/contest/1311/problem/A)
