...
You are given `n` **positive** integers `a₁,a₂,…,aₙ`.
...
The second line of each test case contains `n` positive integers `a₁,a₂,…,aₙ` (`1 ≤ aᵢ ≤ 67`).
...
In the first test case, you can select `a₁` and `a₅` to get `a₁· a₅ = 1 · 67 = 67`.
