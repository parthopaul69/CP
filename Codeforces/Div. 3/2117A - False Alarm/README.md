...
The second line of each test case contains `n` integers `a₁, a₂, ..., aₙ` (`aᵢ ∈ {0, 1}`) — the state of each door. Open doors are represented by `'0'`, while closed doors are represented by `'1'`.
