...
The only line of the input contains four positive integers `x₁, x₂, x₃, x₄` (`2 ≤ xᵢ ≤ 10⁹`) — numbers written on a board in random order. It is guaranteed that the answer exists for the given number `x₁, x₂, x₃, x₄`.
