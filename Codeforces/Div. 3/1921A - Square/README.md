...
| Field | Value |
|---|---|
| **Contest** | [1921](https://codeforces.com/contest/1921) |
| **Problem** | [1921A — Square](https://codeforces.com/contest/1921/problem/A) |
| **Rating** | 800 |
| **Tags** | greedy, math |
| **Verdict** | ✅ Accepted |
...
Each testcase contains four lines, each line contains two integers `xᵢ, yᵢ` (`-1000≤ xᵢ, yᵢ≤ 1000`), coordinates of the corners of the square. 
...
> 🔗 [View on Codeforces](https://codeforces.com/contest/1921/problem/A)
