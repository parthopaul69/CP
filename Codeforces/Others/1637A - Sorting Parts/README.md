...
| Field | Value |
|---|---|
| **Contest** | [1637](https://codeforces.com/contest/1637) |
| **Problem** | [1637A — Sorting Parts](https://codeforces.com/contest/1637/problem/A) |
| **Rating** | 800 |
...
The first line of each test case contains one integer `n` (`2 ≤ n ≤ 10⁴`) — the length of the array.

The second line of the test case contains a sequence of integers `a₁, a₂, …, aₙ` (`1 ≤ aᵢ ≤ 10⁹`) — the array elements.
...
> 🔗 [View on Codeforces](https://codeforces.com/contest/1637/problem/A)
