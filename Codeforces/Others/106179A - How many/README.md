...
| Field | Value |
|---|---|
| **Contest** | [106179](https://codeforces.com/contest/106179) |
| **Problem** | [106179A — How many?](https://codeforces.com/contest/106179/problem/A) |
| **Rating** | Gym/Unrated |
| **Tags** | N/A |
| **Verdict** | ✅ Accepted |
...
The only line of each test case contains two integers `n` and `k` (`1 ≤ k ≤ n ≤ 10¹⁸`; `k ≠ 2`).
...
> 🔗 [View on Codeforces](https://codeforces.com/contest/106179/problem/A)
