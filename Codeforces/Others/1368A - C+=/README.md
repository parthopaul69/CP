...
Each of the following `T` lines describes a single test case, and contains three integers `a, b, n` (`1 ≤ a, b ≤ n ≤ 10⁹`) — initial values of `a` and `b`, and the value one of the variables has to exceed, respectively.
...
> 🔗 [View on Codeforces](https://codeforces.com/contest/1368/problem/A)
