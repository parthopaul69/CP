...
There is a stack of  N  cards, and the  i -th card from the top has an integer  Aᵢ  written on it.
...
Let  Bᵢ  be the integer written on the  i -th card from the top of the stack after the operation. Print  B₁,B₂,…,BN  in this order, separated by spaces.
