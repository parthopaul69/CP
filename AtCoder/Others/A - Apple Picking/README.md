...
There are  N  apple trees lined up in a row in the orchard, numbered tree  1 , tree  2 ,  … , tree  N  from left to right. Tree  i  has  Dᵢ  apples on it.
...
- The second line contains integers  D₁, D₂, …, DN  representing the number of apples on each tree, separated by spaces.
