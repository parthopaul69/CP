...
There are  N  piles of stones on the table, and each pile is numbered from  1  to  N . Pile  i  contains  Aᵢ  stones.
...
- The second line gives  A₁, A₂, …, AN , the number of stones in each pile, separated by spaces.
