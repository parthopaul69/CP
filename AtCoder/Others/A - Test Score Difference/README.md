...
There are  N  students in Takahashi's class besides Takahashi himself. In a recent test, Takahashi scored  X  points. The  i -th student  (1 ≤ i ≤ N)  scored  Aᵢ  points.

Takahashi feels frustrated when he sees a student who scored higher than him. For each student  i , the frustration Takahashi feels is  Aᵢ - X  if  Aᵢ > X , and  0  otherwise.
...
- The second line contains the scores of the  N  students  A₁, A₂, …, AN , separated by spaces.
